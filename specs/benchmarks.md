...
## 2. HLFSR-64 + Poly1305 对称加密

纯密钥流 + Poly1305 认证（无 ECDH/HKDF）。
...
X25519 ECDH + HKDF-SHA256 + HLFSR-64 + Poly1305。enc+dec 综合。

| 块大小 | 吞吐 |
|--------|------|
| 8 MiB | **0.67 GB/s** (enc 0.61, dec 0.75) |
| 64 MiB | **0.66 GB/s** (enc 0.57, dec 0.80) |

瓶颈在 X25519 临时密钥对生成（~0.3ms/次），8 MiB 以上块大小时对称部分摊薄已到极限。

## 4. 统计检验 — 官方 NIST SP 800-22 (STS 2.1.2)
